                   ...
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/01.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/02.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/03.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/04.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/05.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                   <li>
                      <a href="javascript:void(0);">
                         <div class="movie-slick position-relative">
                            <img src="{{(asset('images/trending/06.jpg'))}}" class="img-fluid" alt="">
                         </div>
                      </a>
                   </li>
                </ul>
                <ul id="trending-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                   <li>
                      <div class="tranding-block position-relative"
                         style="background-image: url({{(asset('images/trending/01.jpg'))}});">
                            ...
                            <div class="trending-content">
                               <div id="trending-data1" class="overview-tab tab-pane fade active show">
                                  <div class="trending-info align-items-center w-100 animated fadeInUp">
                                     <a href="javascript:void(0);" tabindex="0">
                                        <div class="res-logo">
                                           <div class="channel-logo">
                                              <img src="{{asset('images/logojeune.png')}}" class="c-logo" alt="streamit">
                                           </div>
                                        </div>
                                     </a>
                                     ...
                                     <div class="d-flex align-items-center series mb-4">
                                        <a href="javascript:void(0);"><img src="{{asset('images/trending/trending-label.png')}}"
                                     ...
                                     <div class="p-btns">
                                        <div class="d-flex align-items-center p-0">
                                           <a href="{{url('/admin/detailfilm')}}" class="btn btn-hover mr-2" tabindex="0"><i
                               ...
                               <div id="trending-data2" class="overlay-tab tab-pane fade">
                                  <div
                                     ...
                                     <a href="{{url('/admin/detailfilm')}}" tabindex="0">
                                        <div class="channel-logo">
                                           <img src="{{asset('images/logojeune.png')}}" class="c-logo" alt="stramit">
                                        </div>
                                     </a>
                                     <h1 class="trending-text big-title text-uppercase">the hero camp</h1>
                                        ...
                                        <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                           <div class="e-item">
                                              <div class="block-image position-relative">
                                                 <a href="{{url('/admin/detailfilm')}}">
                                                 <img src="{{asset('images/episodes/01.jpg')}}" class="img-fluid" alt="">
                                                 </a>
                                                 <div class="episode-play-info">
                                                    <div class="episode-play">
                                                       <a href="{{url('/admin/detailfilm')}}" tabindex="0"><i
                                              ...
                                              <div class="episodes-description text-body">
                                                 <div class="d-flex align-items-center justify-content-between">
                                                    <a href="{{url('/admin/detailfilm')}}">Episode 1</a>
                                           ...
                                           <div class="e-item">
                                              <div class="block-image position-relative">
                                                 <a href="{{url('/admin/detailfilm')}}">
                                                 <img src="{{asset('images/episodes/02.jpg')}}" class="img-fluid" alt="">
                                                 </a>
                                                 <div class="episode-play-info">
                                                    <div class="episode-play">
                                                       <a href="{{url('/admin/detailfilm')}}" tabindex="0"><i
                                              ...
                                              <div class="episodes-description text-body ">
                                                 <div class="d-flex align-items-center justify-content-between">
                                                    <a href="{{url('/admin/detailfilm')}}">Episode 2</a>
                                           ...
                                           <div class="e-item">
                                              <div class="block-image position-relative">
                                                 <a href="{{url('/admin/detailfilm')}}">
                                                 <img src="{{asset('images/episodes/03.jpg')}}" class="img-fluid" alt="">
                                                 </a>
                                                 <div class="episode-play-info">
                                                    <div class="episode-play">
                                                       <a href="{{url('/admin/detailfilm')}}" tabindex="0"><i
                                              ...
                                              <div class="episodes-description text-body">
                                                 <div class="d-flex align-items-center justify-content-between">
                                                    <a href="{{url('/admin/detailfilm')}}">Episode 3</a>
                                           ...
                                           <div class="e-item">
                                              <div class="block-image position-relative">
                                                 <a href="{{url('/admin/detailfilm')}}">
                                                 <img src="{{asset('images/episodes/04.jpg')}}" class="img-fluid" alt="">
                                                 </a>
                                                 <div class="episode-play-info">
                                                    <div class="episode-play">
                                                       <a href="{{url('/admin/detailfilm')}}" tabindex="0"><i
                                              ...
                                              <div class="episodes-description text-body ">
                                                 <div class="d-flex align-items-center justify-content-between">
                                                    <a href="{{url('/admin/detailfilm')}}">Episode 4</a>
                                           ...
                                           <div class="e-item">
                                              <div class="block-image position-relative">
                                                 <a href="{{url('/admin/detailfilm')}}">
                                                 <img src="{{asset('images/episodes/05.jpg')}}" class="img-fluid" alt="">
                                                 </a>
                                                 <div class="episode-play-info">
                                                    <div class="episode-play">
                                                       <a href="{{url('/admin/detailfilm')}}" tabindex="0"><i
                                              ...
                                              <div class="episodes-description text-body">
                                                 <div class="d-flex align-items-center justify-content-between">
                                                    <a href="{{url('/admin/detailfilm')}}">Episode 5</a>
                            ...
                            <div class="trending-content">
                               ...
                               <div id="trending-data6" class="overlay-tab tab-pane fade">
                                  <div
                                     ...
                                     <a href="{{url('/admin/detailfilm')}}" tabindex="0">
                                        <div class="channel-logo">
                                           <img src="images/logojeune.png" class="c-logo" alt="stramit">
                                        </div>
                                     </a>
                                     <h1 class="trending-text big-title text-uppercase">The Appartment</h1>
                                     <div class="d-flex align-items-center text-white text-detail mb-4">
                               ...
                               <div id="trending-data9" class="overview-tab tab-pane fade active show">
                                  <div
                                     ...
                                     <a href="javascript:void(0);" tabindex="0">
                                        <div class="res-logo">
                                           <div class="channel-logo">
                                              <img src="images/logojeune.png" class="c-logo" alt="streamit">
                                           </div>
                                        </div>
                                     </a>
