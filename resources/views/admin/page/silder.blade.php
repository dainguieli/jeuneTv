              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$increment}}</td>
                    <td>
                      <img src="{{asset('storage/slider_images/'.$silder->image)}}" style="height : 50px; width : 50px"
                        class="img-circle elevation-2" alt="User Image">
                    </td>
                    <td>{{$silder->description1}}
                    </td>
                    <td>{{$silder->description2}}</td>
                    <td>
                      @if ($silder->status==1)
                      ...
                      <a href="{{url('admin/modifierSilder/'.$silder->id)}}" class="btn btn-primary"><i
                          class="nav-icon fas fa-edit"></i></a>
                      <a href="#" onclick="$(this).parent().find('form').submit()" id="delete" class="btn btn-danger"><i
