...
<link rel="manifest" href="{{ asset('/manifest.json') }}">
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="images/logojeune.png" />
        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="css/bootstrap.min.css" />
            <link rel="stylesheet" href="css/bootstrap.min.css.map" />  <!-- Typography CSS -->
        ...
        <link rel="stylesheet" href="js/fontawesome-webfont.woff" />
