          ...
          <div class="row">
             <div class="col-sm-12">
                <nav class="navbar navbar-expand-lg navbar-light p-0"> 
                   ...
                   <a class="navbar-brand" href="{{ url('/') }}"> <img class="img-fluid logo" style="width: 5.5rem; " src="images/logojeune.png"
                      alt="streamit" /> </a>
                   <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      <div class="menu-main-menu-container">
                         <ul id="top-menu" class="navbar-nav ml-auto">
                            ...
                            <li class="menu-item">
                              <a href="{{ url('/login') }}">Programmes</a>
                           </li> 
                            <li class="menu-item">
                               <a href="{{ url('/login') }}">Stream</a>
                            </li> 
                            <li class="menu-item">
                              <a href="{{ url('/login') }}">Jeune Mag</a>
                           </li> 
                            <li class="menu-item">
                               <a href="{{ url('/login') }}">Direct</a>
                            </li>                                                              
                            <!-- <li class="menu-item">
                            ...
                            <li class="menu-item">
                               <a href="#">Pages</a>
                               <ul class="sub-menu">
                                  <li class="menu-item"><a href="{{ url('/login') }}">À propos de nous</a></li>
                                  <li class="menu-item "><a href="{{ url('/contact') }}">Contact</a></li>
                                  <li class="menu-item"><a href="{{ url('/faq') }}">FAQ</a></li>
                                  <li class="menu-item"><a href="{{ url('/privacy-policy') }}">Politique de confidentialité</a></li>
                               <!--
                                  <li class="menu-item"><a href="#">Tarification</a>
                                  <ul class="sub-menu">
                                     <li class="menu-item"><a href="{{ url('/pricing-plan-1') }}">Pricing Plan 1</a></li>
                                     <li class="menu-item"><a href="{{ url('/pricing-plan-2') }}">Pricing Plan 2</a></li>
                                  </ul>
                               </li>
                               </ul>
                              -->
